...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    source: 'packages/client/ui-chat/src/client/contract/slots.ts:330',
  },
  {
  ...
  },
  {
    ...
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'conversation.chat.turnEndInfo\', () => ctx.slots.register(\n      { name: \'conversation.chat.turnEndInfo\', id: \'my-entry\', order: 100, label: \'My entry\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-chat/src/client/contract/slots.ts:324',
  },
  {
    ...
    declaredBy: 'an entry in \'conversation.chat.node\' (client-ui-chat), so it exists while that entry is mounted',
    occupants: [
      'client-ui-billing TurnCostMeterTail id \'billing\'',
