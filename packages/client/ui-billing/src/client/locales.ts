...
export const zh = {
  ...
  'section.windowNote': '高峰时段为北京时间周一至周五 9:00–12:00、14:00–18:00，其余为空闲时段；官方公布的空闲单价为高峰价的一半。当前：{window}。',
  'window.peak': '高峰时段',
  'window.offPeak': '空闲时段',
...
export const en: Record<BillingKey, string> = {
  ...
  'section.windowNote': 'Peak hours are Beijing time Monday–Friday 09:00–12:00 and 14:00–18:00, and every other hour is off-peak; the published off-peak rate is half the peak one. Now: {window}.',
  'window.peak': 'peak',
