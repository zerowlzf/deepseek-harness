 ...
 * ui-settings-models, ui-settings-plugins, ui-agent-preset, and ui-billing. A
 * plugin adding a section changes this list.
 */
const PRODUCT_SECTIONS: readonly string[] = ['general', 'models', 'plugins', 'agent-presets', 'billing']
